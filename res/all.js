/* all.js - Turtle skin scripts */
var VER='5.4.3',DEBUG=true;
...
var printImage = function(src, title, caption) {
...
(function($) {
	...
	******************************************************** */
	...
	$.fn.turtle = function( settings, id ) {
		...
		( 	(settings.linkSlides && (settings.shares.facebookLike || settings.shares.facebook || settings.shares.gplus)) || 
		...
		var createInfo = function(im, n) {
			...
			if ( xs || (d && ((!isimg && settings.downloadNonImages) || (isimg && !settings.rightClickProtect))) ) {
				var fn = src.getFile(),
					tt = $('<div>'),
					a = $('<a>', { 
						href: d, 
